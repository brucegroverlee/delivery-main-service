...
export interface RecipientRejectRequestData {
  deliveryId: DeliveryId;
}

class RecipientRejectRequest {
  constructor(private repository: DeliveryRepository, private eventBus: EventBus, private presenter: Presenter) {}

  async run(data: RecipientRejectRequestData): Promise<void> {
...
export default RecipientRejectRequest;
