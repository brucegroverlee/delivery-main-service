...
class CarrierArriveSenderLocationControllerMother {
  static async givenADeliveryWaitingForCarrier(): Promise<{ delivery: DeliveryDTO }> {
...
export default CarrierArriveSenderLocationControllerMother;
