...
class StartDeliveryControllerMother {
  static async givenADeliveryWaitingForStart(): Promise<{ delivery: DeliveryDTO }> {
...
export default StartDeliveryControllerMother;
