...
class AssignCarrierIdSubscriberMother {
  static async givenADeliveryWithFareAccepted(): Promise<{ delivery: DeliveryDTO }> {
    ...
    delivery.status = DeliveryStatus.DELIVERY_FARE_ACCEPTED_BY_SENDER;
...
export default AssignCarrierIdSubscriberMother;
